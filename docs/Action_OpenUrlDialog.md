---
title: "Action.OpenUrlDialog"
source: "https://adaptivecards.microsoft.com/?topic=Action.OpenUrlDialog"
topic: "Action.OpenUrlDialog"
---
...
`Action.OpenUrlDialog` is currently not supported in Teams. To achieve the same result in Teams, use Action.Submit with a subtype of `task/fetch`. See [Use dialogs in Microsoft Teams bots](https://learn.microsoft.com/en-us/microsoftteams/platform/task-modules-and-cards/task-modules/task-modules-bots) for more details.
...
| --- | --- | --- | --- | --- |
| type | string | Must be Action.OpenUrlDialog. | 1.0 |
| url | string | The URL to open. | 1.5 |
| dialogHeight | string | The height of the dialog. To define height as a number of pixels, use the <number>px format. Valid values: \`small\`, \`medium\`, \`large\`, \`<number>px\` | 1.5 |
| dialogTitle | string | The title of the dialog to be displayed in the dialog header. | 1.5 |
| dialogWidth | string | The width of the dialog. To define width as a number of pixels, use the <number>px format. Valid values: \`small\`, \`medium\`, \`large\`, \`<number>px\` | 1.5 |
