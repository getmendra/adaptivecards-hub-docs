---
title: "Persona"
source: "https://adaptivecards.microsoft.com/?topic=Component.graph.microsoft.com/user"
topic: "Component.graph.microsoft.com/user"
---
...
| name | string | Must be graph.microsoft.com/user. | 1.5 |
| properties | object | The properties of the user. Valid values: \`PersonaProperties\` | 1.0 |
