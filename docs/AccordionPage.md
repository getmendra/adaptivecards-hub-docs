---
title: "AccordionPage"
source: "https://adaptivecards.microsoft.com/?topic=AccordionPage"
topic: "AccordionPage"
---
...
A single page within an accordion.
...
| --- | --- | --- | --- | --- |
| type | string | Must be AccordionPage. | 1.0 |
| expandIconPosition | string | "Start" | Controls the position of the expand/collapse icon. Valid values: \`Start\`, \`Inline\`, \`End\` | 1.5 |
| headerIconName | string | The name of the icon to display in the header. | 1.5 |
| headerSize | string | "Medium" | Controls the size of the header. Valid values: \`Small\`, \`Medium\`, \`Large\`, \`XLarge\` | 1.5 |
| headerTitle | string | The header text of the accordion page. | 1.5 |
| headerWrap | boolean | true | Controls whether the header text is wrapped. | 1.5 |
| isExpanded | boolean | false | Controls whether the page is expanded. | 1.5 |
