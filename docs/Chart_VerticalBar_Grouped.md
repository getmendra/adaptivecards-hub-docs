---
title: "Chart.VerticalBar.Grouped"
source: "https://adaptivecards.microsoft.com/?topic=Chart.VerticalBar.Grouped"
topic: "Chart.VerticalBar.Grouped"
---
...
| --- | --- | --- | --- | --- |
| type | string | Must be Chart.VerticalBar.Grouped. | 1.0 |
...
| data | Array ofobject | The data points in a series. Valid values: \`GroupedVerticalBarChartData\` | 1.5 |
...
| showBarValues | boolean | false | Controls if values should be displayed on each bar. | 1.5 |
...
| stacked | boolean | false | Controls if bars in the chart should be displayed as stacks instead of groups. Note: stacked vertical bar charts do not support custom Y ranges nor negative Y values. | 1.5 |
...
| yMax | number | The requested maximum for the Y axis range. The value used at runtime may be different to optimize visual presentation. yMax is ignored if stacked is set to true. | 1.5 |
| yMin | number | The requested minimum for the Y axis range. The value used at runtime may be different to optimize visual presentation. yMin is ignored if stacked is set to true. | 1.5 |