---
title: "Media"
source: "https://adaptivecards.microsoft.com/?topic=Media"
topic: "Media"
---
...
> Important
> 
> For **YouTube**, **Vimeo** and **Dailymotion** videos, make sure to set the `contentType` property of the `mediaSource` to `video/mp4`, as shown below.
...
| --- | --- | --- | --- | --- |
| type | string | Must be Media. | 1.0 |
| altText | string | The alternate text for the media, used for accessibility purposes. | 1.1 |
| captionSources | Array ofobject | The caption sources for the media. Caption sources are not used for YouTube, Dailymotion or Vimeo sources. Valid values: \`CaptionSource\` | 1.6 |
...
| poster | string | The URL of the poster image to display. | 1.1 |
...
| sources | Array ofobject | The sources for the media. For YouTube, Dailymotion and Vimeo, only one source can be specified. Valid values: \`MediaSource\` | 1.1 |
