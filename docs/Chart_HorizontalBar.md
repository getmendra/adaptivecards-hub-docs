---
title: "Chart.HorizontalBar"
source: "https://adaptivecards.microsoft.com/?topic=Chart.HorizontalBar"
topic: "Chart.HorizontalBar"
---
...
> Tip
> 
> `Chart.HorizontalBar` does not support negative x-axis values. If you need negative x-axis values, use Chart.Line instead.
...
| --- | --- | --- | --- | --- |
| type | string | Must be Chart.HorizontalBar. | 1.0 |
...
| data | Array ofobject | The data points in the chart. Valid values: \`HorizontalBarChartDataValue\` | 1.5 |
| displayMode | string | "AbsoluteWithAxis" | Controls how the chart should be visually laid out. Valid values: \`AbsoluteWithAxis\`, \`AbsoluteNoAxis\`, \`PartToWhole\` | 1.5 |
