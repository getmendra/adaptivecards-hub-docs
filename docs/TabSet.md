---
title: "TabSet"
source: "https://adaptivecards.microsoft.com/?topic=TabSet"
topic: "TabSet"
---
...
| --- | --- | --- | --- | --- |
| type | string | Must be TabSet. | 1.0 |
| pages | Array ofobject | The pages in the tab set. Valid values: \`TabPage\` |  |
| size | string | "Medium" | Controls the size of tab icons and titles. Valid values: \`Small\`, \`Medium\`, \`Large\` | 1.5 |
