...
source: "https://adaptivecards.microsoft.com/?topic=Chart.VerticalBar"
topic: "Chart.VerticalBar"
---
...
| --- | --- | --- | --- | --- |
| type | string | Must be Chart.VerticalBar. | 1.0 |
...
| data | Array ofobject | The data to display in the chart. Valid values: \`VerticalBarChartDataValue\` | 1.5 |
...
| showBarValues | boolean | false | Controls if the bar values should be displayed. | 1.5 |
...
| yMax | number | The requested maximum for the Y axis range. The value used at runtime may be different to optimize visual presentation. | 1.5 |
| yMin | number | The requested minimum for the Y axis range. The value used at runtime may be different to optimize visual presentation. | 1.5 |