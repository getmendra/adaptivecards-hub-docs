---
title: "Input.Number"
source: "https://adaptivecards.microsoft.com/?topic=Input.Number"
topic: "Input.Number"
---
...
| --- | --- | --- | --- | --- |
| type | string | Must be Input.Number. | 1.0 |
...
| max | number | The maximum value that can be entered. | 1.0 |
| min | number | The minimum value that can be entered. | 1.0 |
...
| value | number | The default value of the input. | 1.0 |
