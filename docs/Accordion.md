---
title: "Accordion"
source: "https://adaptivecards.microsoft.com/?topic=Accordion"
topic: "Accordion"
---
...
| --- | --- | --- | --- | --- |
| type | string | Must be Accordion. | 1.0 |
| allowCollapseAllPages | boolean | true | Controls whether all accordion pages can be collapsed at the same time. | 1.5 |
| allowMultipleExpandedPages | boolean | false | Controls whether multiple accordion pages can be expanded at the same time. | 1.5 |
| pages | Array ofobject | The pages in the accordion. Valid values: \`AccordionPage\` |  |
