---
title: "Input.Time"
source: "https://adaptivecards.microsoft.com/?topic=Input.Time"
topic: "Input.Time"
---
...
| --- | --- | --- | --- | --- |
| type | string | Must be Input.Time. | 1.0 |
...
| max | string | The maximum time that can be selected, in the HH:MM format. | 1.0 |
| min | string | The minimum time that can be selected, in the HH:MM format. | 1.0 |
...
| value | string | The default value of the input, in the HH:MM format. | 1.0 |
