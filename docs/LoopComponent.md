---
title: "LoopComponent"
source: "https://adaptivecards.microsoft.com/?topic=LoopComponent"
topic: "LoopComponent"
---
...
| --- | --- | --- | --- | --- |
| type | string | Must be LoopComponent. | 1.0 |
| componentUrl | string | The URL of the Loop Component. | 1.5 |
