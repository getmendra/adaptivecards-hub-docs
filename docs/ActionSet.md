---
title: "ActionSet"
source: "https://adaptivecards.microsoft.com/?topic=ActionSet"
topic: "ActionSet"
---
  ...
  "body": [
    {
      "type": "TextBlock",
      "wrap": true,
      "text": "With **ActionSet**, cards can have actions anywhere in their body."
    },
    {
      "type": "ActionSet",
      "actions": [
        {
          ...
          "tooltip": "Click to expand an inline card",
          "card": {
            "type": "AdaptiveCard",
            "body": [
              {
...
| --- | --- | --- | --- | --- |
| type | string | Must be ActionSet. | 1.0 |
| actions | Array ofobject | The actions in the set. Valid values: \`Action.Execute\`, \`Action.InsertImage\`, \`Action.OpenUrl\`, \`Action.OpenUrlDialog\`, \`Action.Popover\`, \`Action.ResetInputs\`, \`Action.RunCommands\`, \`Action.ShowCard\`, \`Action.Submit\`, \`Action.ToggleVisibility\` | 1.0 |
