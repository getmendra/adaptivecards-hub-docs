...
source: "https://adaptivecards.microsoft.com/?topic=Component.graph.microsoft.com/event"
topic: "Component.graph.microsoft.com/event"
---
...
| name | string | Must be graph.microsoft.com/event. | 1.5 |
| properties | object | The properties of the event. Valid values: \`CalendarEventProperties\` | 1.0 |
